...
accumulation_steps = 5 # how many backpropagation calls should we make before updating the model parameters
optimizer.zero_grad()  
...
for epoch in range(epochs):
    ...
    # only step optimizer every 'accumulation_steps' epochs
